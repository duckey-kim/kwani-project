			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel paenl-default">
					...
					<form action="/admin/modifyAlbumAction" method="post"
						...
						<h5>T_ALBUM</h5>
						<div>
							<input  class="form-control"type="text" readonly="readonly" name="albumId" value="${album.albumId }">
						</div>
						
						
						<div>
							<input  class="form-control"placeholder="albumIMG" type="text" name="albumImg" value="${album.albumImg }">
						</div>
						<div>
